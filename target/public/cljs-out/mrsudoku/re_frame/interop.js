...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__8536 = cljs.core.instance_QMARK_;
var expr__8537 = reactive_val;
if(cljs.core.truth_(pred__8536.call(null,reagent.ratom.RAtom,expr__8537))){
return "ra";
} else {
if(cljs.core.truth_(pred__8536.call(null,reagent.ratom.RCursor,expr__8537))){
return "rc";
} else {
if(cljs.core.truth_(pred__8536.call(null,reagent.ratom.Reaction,expr__8537))){
return "rx";
} else {
if(cljs.core.truth_(pred__8536.call(null,reagent.ratom.Track,expr__8537))){
return "tr";
} else {
return "other";
}
