...
var G__10070 = (node__$1.arr[((i__$1 >> shift__$2) & (31))]);
var G__10071 = (shift__$2 - (5));
node__$1 = G__10070;
shift__$2 = G__10071;
continue;
}
...
var G__10073 = i__$2;
var G__10074 = (node.arr[j]);
var G__10075 = (shift__$1 - (5));
i__$1 = G__10073;
node = G__10074;
shift__$1 = G__10075;
continue;
...
var n_10080 = ret;
var shift_10081__$1 = shift;
while(true){
var arr_10082__$1 = n_10080.arr;
var subidx_10083 = (((cnt - (1)) >> shift_10081__$1) & (31));
if((shift_10081__$1 === (5))){
(arr_10082__$1[subidx_10083] = tail_node);
} else {
var temp__5718__auto___10084 = (arr_10082__$1[subidx_10083]);
if(cljs.core.truth_(temp__5718__auto___10084)){
var child_10085 = temp__5718__auto___10084;
var new_carr_10086 = cljs.core.aclone.call(null,child_10085.arr);
var new_child_10087 = cljs.core.__GT_VectorNode.call(null,root_edit,new_carr_10086);
(arr_10082__$1[subidx_10083] = new_child_10087);

var G__10088 = new_child_10087;
var G__10089 = (shift_10081__$1 - (5));
n_10080 = G__10088;
shift_10081__$1 = G__10089;
continue;
} else {
(arr_10082__$1[subidx_10083] = clojure.core.rrb_vector.trees.new_path.call(null,tail_node.arr,root_edit,(shift_10081__$1 - (5)),tail_node));
}
}
break;
}
...
var shift_10091__$1 = shift;
var node_10092__$1 = node;
while(true){
if((shift_10091__$1 === (0))){
var arr_10093 = node_10092__$1.arr;
(arr_10093[(i & (31))] = val);
} else {
var arr_10094 = node_10092__$1.arr;
var subidx_10095 = ((i >> shift_10091__$1) & (31));
var child_10096 = clojure.core.rrb_vector.nodes.clone.call(null,shift_10091__$1,(arr_10094[subidx_10095]));
(arr_10094[subidx_10095] = child_10096);

var G__10097 = (shift_10091__$1 - (5));
var G__10098 = child_10096;
shift_10091__$1 = G__10097;
node_10092__$1 = G__10098;
continue;
}
break;
}
