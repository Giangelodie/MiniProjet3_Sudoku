...
var G__12857 = devtools.prefs.pref.call(null,v);
v = G__12857;
continue;
} else {
return v;
...
}catch (e12860){var _e__11872__auto__ = e12860;
return false;
}})();
...
}catch (e12864){var _e__11872__auto__ = e12864;
return false;
}})();
...
}catch (e12866){var _e__11872__auto__ = e12866;
return false;
}}
}
});
...
var vec__12868 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__12868,(0),null);
var name = cljs.core.nth.call(null,vec__12868,(1),null);
...
return cljs.core.some.call(null,(function (p1__12871_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12871_SHARP_);
}),template);
});
