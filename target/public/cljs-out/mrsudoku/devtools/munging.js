...
var o12755 = temp__5718__auto__;
var temp__5718__auto____$1 = (o12755["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o12756 = temp__5718__auto____$1;
return (o12756["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11865__auto__ = f;
return (o__11865__auto__["toString"]).call(o__11865__auto__);
} else {
return "";
}
}catch (e12757){var _ = e12757;
return "";
}});
...
try{var o__11865__auto___12759 = t;
(o__11865__auto___12759["cljs$lang$ctorPrWriter"]).call(o__11865__auto___12759,t,writer);
}catch (e12758){var __12760 = e12758;
}
...
var char_code = (function (){var o__11865__auto__ = (new String(char$));
return (o__11865__auto__["charCodeAt"]).call(o__11865__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11865__auto__ = String;
return (o__11865__auto__["fromCharCode"]).call(o__11865__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12761 = num_code;
switch (G__12761) {
case (1):
return (185);
...
var o__11865__auto__ = String;
return (o__11865__auto__["fromCharCode"]).call(o__11865__auto__,superscript_code);
});
/**
...
}catch (e12763){var _e__11872__auto__ = e12763;
return false;
}})())){
...
var vec__12764 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__12764,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o12767 = temp__5718__auto__;
var temp__5718__auto____$1 = (o12767["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o12768 = temp__5718__auto____$1;
return (o12768["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___12775 = arguments.length;
var i__4532__auto___12776 = (0);
while(true){
if((i__4532__auto___12776 < len__4531__auto___12775)){
args__4534__auto__.push((arguments[i__4532__auto___12776]));

var G__12777 = (i__4532__auto___12776 + (1));
i__4532__auto___12776 = G__12777;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12771){
var vec__12772 = p__12771;
var ns_detector = cljs.core.nth.call(null,vec__12772,(0),null);
...
var G__12778 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__12779 = cljs.core.butlast.call(null,remaining_tokens);
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12769){
var G__12770 = cljs.core.first.call(null,seq12769);
var seq12769__$1 = cljs.core.next.call(null,seq12769);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12770,seq12769__$1);
});
...
var vec__12783 = cljs.core.split_with.call(null,(function (p1__12782_SHARP_){
return cljs.core.not_EQ_.call(null,p1__12782_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__12783,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__12783,(1),null);
...
var vec__12786 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__12786,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__12786,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__12789 = cljs.core.rest.call(null,remaining_tokens);
var G__12790 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
...
var vec__12793 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__12793,(0),null);
var arity = cljs.core.nth.call(null,vec__12793,(1),null);
var vec__12796 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__12796,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__12796,(1),null);
var vec__12799 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__12799,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__12799,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__12799,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__12799,(3),null);
...
var vec__12805 = result;
var munged_ns = cljs.core.nth.call(null,vec__12805,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__12805,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__12805,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__12805,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__12805,(4),null);
var arity = cljs.core.nth.call(null,vec__12805,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__12809 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__12809,(0),null);
var args = cljs.core.nth.call(null,vec__12809,(1),null);
var vec__12812 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__12812,(0),null);
var name = cljs.core.nth.call(null,vec__12812,(1),null);
...
var G__12815 = (arity + (1));
var G__12816 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12817){
var vec__12818 = p__12817;
var arity = cljs.core.nth.call(null,vec__12818,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__12818,(1),null);
...
return cljs.core.get.call(null,arities,p1__12821_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__12822_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___12829 = arguments.length;
var i__4532__auto___12830 = (0);
while(true){
if((i__4532__auto___12830 < len__4531__auto___12829)){
args__4534__auto__.push((arguments[i__4532__auto___12830]));

var G__12831 = (i__4532__auto___12830 + (1));
i__4532__auto___12830 = G__12831;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12825){
var vec__12826 = p__12825;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__12826,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12823){
var G__12824 = cljs.core.first.call(null,seq12823);
var seq12823__$1 = cljs.core.next.call(null,seq12823);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12824,seq12823__$1);
});
...
var map__12834 = options;
var map__12834__$1 = ((((!((map__12834 == null)))?(((((map__12834.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12834.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12834):map__12834);
var include_ns_QMARK_ = cljs.core.get.call(null,map__12834__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__12834__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__12834__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__12834__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12835 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__12835,(0),null);
var fn_name = cljs.core.nth.call(null,vec__12835,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__12835,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__12835,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__12835,(4),null);
var arity = cljs.core.nth.call(null,vec__12835,(5),null);
...
var o__11865__auto__ = f;
return (o__11865__auto__["getBasis"]).call(o__11865__auto__);
});
/**
...
}catch (e12839){var _e__11872__auto__ = e12839;
...
var G__12840 = (obj[cljs.core.first.call(null,path)]);
var G__12841 = cljs.core.rest.call(null,path);
obj = G__12840;
path = G__12841;
continue;
} else {
...
return (function (accum,p__12842){
var vec__12843 = p__12842;
var bit = cljs.core.nth.call(null,vec__12843,(0),null);
var protocol = cljs.core.nth.call(null,vec__12843,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12846){
var vec__12847 = p__12846;
var ns = cljs.core.nth.call(null,vec__12847,(0),null);
var name = cljs.core.nth.call(null,vec__12847,(1),null);
var selector = cljs.core.nth.call(null,vec__12847,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__12852,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__12852,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__12852,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__12850_SHARP_){
return (obj[cljs.core.first.call(null,p1__12850_SHARP_)]);
});})(name,sorted_matches,vec__12852,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
