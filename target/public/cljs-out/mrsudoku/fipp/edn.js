...
fipp.edn.pretty_coll = (function fipp$edn$pretty_coll(p__10456,open,xs,sep,close,f){
...
var printer = map__10457__$1;
var print_level = cljs.core.get.call(null,map__10457__$1,new cljs.core.Keyword(null,"print-level","print-level",-1825423733));
var print_length = cljs.core.get.call(null,map__10457__$1,new cljs.core.Keyword(null,"print-length","print-length",1931866356));
var printer__$1 = (function (){var G__10459 = printer;
if(cljs.core.truth_(print_level)){
return cljs.core.update.call(null,G__10459,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),cljs.core.dec);
} else {
return G__10459;
}
})();
var xform = cljs.core.comp.call(null,(cljs.core.truth_(print_length)?cljs.core.take.call(null,print_length):cljs.core.identity),cljs.core.map.call(null,((function (printer__$1,map__10457,map__10457__$1,printer,print_level,print_length){
return (function (p1__10455_SHARP_){
return f.call(null,printer__$1,p1__10455_SHARP_);
});})(printer__$1,map__10457,map__10457__$1,printer,print_level,print_length))
...
fipp.edn.EdnPrinter.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4205__auto__,k10461,else__4206__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k10461,else__4206__auto__);
...
fipp.edn.EdnPrinter.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__10460){
var self__ = this;
var G__10460__$1 = this;
return (new cljs.core.RecordIter((0),G__10460__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"symbols","symbols",1211743),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
fipp.edn.EdnPrinter.prototype.fipp$visit$IVisitor$visit_tagged$arity$2 = (function (this$,p__10466){
var self__ = this;
...
var tag = cljs.core.get.call(null,map__10467__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var form = cljs.core.get.call(null,map__10467__$1,new cljs.core.Keyword(null,"form","form",-1624062471));
var this$__$1 = this;
...
return (function (printer,p__10469){
var vec__10470 = p__10469;
var k = cljs.core.nth.call(null,vec__10470,(0),null);
var v = cljs.core.nth.call(null,vec__10470,(1),null);
...
fipp.edn.EdnPrinter.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this10462,other10463){
var self__ = this;
var this10462__$1 = this;
return ((!((other10463 == null))) && ((this10462__$1.constructor === other10463.constructor)) && (cljs.core._EQ_.call(null,this10462__$1.symbols,other10463.symbols)) && (cljs.core._EQ_.call(null,this10462__$1.print_meta,other10463.print_meta)) && (cljs.core._EQ_.call(null,this10462__$1.print_length,other10463.print_length)) && (cljs.core._EQ_.call(null,this10462__$1.print_level,other10463.print_level)) && (cljs.core._EQ_.call(null,this10462__$1.__extmap,other10463.__extmap)));
});
...
fipp.edn.EdnPrinter.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4210__auto__,k__4211__auto__,G__10460){
var self__ = this;
var this__4210__auto____$1 = this;
var pred__10473 = cljs.core.keyword_identical_QMARK_;
var expr__10474 = k__4211__auto__;
if(cljs.core.truth_(pred__10473.call(null,new cljs.core.Keyword(null,"symbols","symbols",1211743),expr__10474))){
return (new fipp.edn.EdnPrinter(G__10460,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__10473.call(null,new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),expr__10474))){
return (new fipp.edn.EdnPrinter(self__.symbols,G__10460,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__10473.call(null,new cljs.core.Keyword(null,"print-length","print-length",1931866356),expr__10474))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,G__10460,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__10473.call(null,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),expr__10474))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,G__10460,self__.__meta,self__.__extmap,null));
} else {
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4211__auto__,G__10460),null));
}
}
}
}
...
fipp.edn.EdnPrinter.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4202__auto__,G__10460){
var self__ = this;
var this__4202__auto____$1 = this;
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,G__10460,self__.__extmap,self__.__hash));
});
 ...
 */
fipp.edn.map__GT_EdnPrinter = (function fipp$edn$map__GT_EdnPrinter(G__10464){
var extmap__4236__auto__ = (function (){var G__10476 = cljs.core.dissoc.call(null,G__10464,new cljs.core.Keyword(null,"symbols","symbols",1211743),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733));
if(cljs.core.record_QMARK_.call(null,G__10464)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__10476);
} else {
return G__10476;
}
})();
return (new fipp.edn.EdnPrinter(new cljs.core.Keyword(null,"symbols","symbols",1211743).cljs$core$IFn$_invoke$arity$1(G__10464),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598).cljs$core$IFn$_invoke$arity$1(G__10464),new cljs.core.Keyword(null,"print-length","print-length",1931866356).cljs$core$IFn$_invoke$arity$1(G__10464),new cljs.core.Keyword(null,"print-level","print-level",-1825423733).cljs$core$IFn$_invoke$arity$1(G__10464),null,cljs.core.not_empty.call(null,extmap__4236__auto__),null));
});
...
var _STAR_print_meta_STAR_10480 = cljs.core._STAR_print_meta_STAR_;
cljs.core._STAR_print_meta_STAR_ = false;

try{return fipp.engine.pprint_document.call(null,fipp.visit.visit.call(null,printer,x),options);
}finally {cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR_10480;
}});
