...
var G__9911 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__9911,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__9911;
}
});
...
var len__4531__auto___9916 = arguments.length;
var i__4532__auto___9917 = (0);
while(true){
if((i__4532__auto___9917 < len__4531__auto___9916)){
args__4534__auto__.push((arguments[i__4532__auto___9917]));

var G__9918 = (i__4532__auto___9917 + (1));
i__4532__auto___9917 = G__9918;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq9913){
var G__9914 = cljs.core.first.call(null,seq9913);
var seq9913__$1 = cljs.core.next.call(null,seq9913);
var G__9915 = cljs.core.first.call(null,seq9913__$1);
var seq9913__$2 = cljs.core.next.call(null,seq9913__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9914,G__9915,seq9913__$2);
});
...
var map__9920 = m;
var map__9920__$1 = ((((!((map__9920 == null)))?(((((map__9920.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9920.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9920):map__9920);
var file = cljs.core.get.call(null,map__9920__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__9920__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__9920__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__9920,map__9920__$1,file,line,column){
return (function (p1__9919_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__9919_SHARP_));
});})(map__9920,map__9920__$1,file,line,column))
...
var temp__5720__auto___9922 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___9922)){
var message_9923 = temp__5720__auto___9922;
cljs.core.println.call(null,message_9923);
} else {
}
...
var temp__5720__auto___9924 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___9924)){
var message_9925 = temp__5720__auto___9924;
cljs.core.println.call(null,message_9925);
} else {
}
...
var output_dir__$1 = (function (){var G__9926 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__9926),"/"].join('');
} else {
return G__9926;
}
})();
...
var G__9928 = exception.stack;
var G__9928__$1 = (((G__9928 == null))?null:clojure.string.split_lines.call(null,G__9928));
var G__9928__$2 = (((G__9928__$1 == null))?null:cljs.core.get.call(null,G__9928__$1,depth));
if((G__9928__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__9928__$2);
}
} else {
...
var vec__9929 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__9929,(0),null);
var column = cljs.core.nth.call(null,vec__9929,(1),null);
var vec__9932 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__9932,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__9932,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__9932,(2),null);
...
var m__$1 = (function (){var G__9935 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__9935__$1 = (((G__9935 instanceof cljs.core.Keyword))?G__9935.fqn:null);
switch (G__9935__$1) {
case "fail":
...
var G__9939 = (function (){var G__9938 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__9938);
} else {
return G__9938;
}
})();
...
return cljs.core.vary_meta.call(null,G__9940,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__9944 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__9944,(0),null);
var types = vec__9944;
...
return cljs.core.map.call(null,(function (p__9947){
var vec__9948 = p__9947;
var ns = cljs.core.nth.call(null,vec__9948,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__9948,(1),null);
return ((function (vec__9948,ns,vars__$1){
return (function (){
...
var G__9951 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__9951,G__9951__$1,env,once_fixtures,each_fixtures,vec__9948,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__9951,G__9951__$1,env,once_fixtures,each_fixtures,vec__9948,ns,vars__$1){
return (function (){
var seq__9952 = cljs.core.seq.call(null,vars__$1);
var chunk__9953 = null;
var count__9954 = (0);
var i__9955 = (0);
while(true){
if((i__9955 < count__9954)){
var v = cljs.core._nth.call(null,chunk__9953,i__9955);
var temp__5720__auto___9957 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___9957)){
var t_9958 = temp__5720__auto___9957;
each_fixture_fn.call(null,((function (seq__9952,chunk__9953,count__9954,i__9955,t_9958,temp__5720__auto___9957,v,each_fixture_fn,G__9951,G__9951__$1,env,once_fixtures,each_fixtures,vec__9948,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_9958)));
});})(seq__9952,chunk__9953,count__9954,i__9955,t_9958,temp__5720__auto___9957,v,each_fixture_fn,G__9951,G__9951__$1,env,once_fixtures,each_fixtures,vec__9948,ns,vars__$1))
);
} else {
}


var G__9959 = seq__9952;
var G__9960 = chunk__9953;
var G__9961 = count__9954;
var G__9962 = (i__9955 + (1));
seq__9952 = G__9959;
chunk__9953 = G__9960;
count__9954 = G__9961;
i__9955 = G__9962;
...
var temp__5720__auto__ = cljs.core.seq.call(null,seq__9952);
if(temp__5720__auto__){
var seq__9952__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__9952__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__9952__$1);
var G__9963 = cljs.core.chunk_rest.call(null,seq__9952__$1);
var G__9964 = c__4351__auto__;
var G__9965 = cljs.core.count.call(null,c__4351__auto__);
var G__9966 = (0);
seq__9952 = G__9963;
chunk__9953 = G__9964;
count__9954 = G__9965;
...
var v = cljs.core.first.call(null,seq__9952__$1);
var temp__5720__auto___9967__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___9967__$1)){
var t_9968 = temp__5720__auto___9967__$1;
each_fixture_fn.call(null,((function (seq__9952,chunk__9953,count__9954,i__9955,t_9968,temp__5720__auto___9967__$1,v,seq__9952__$1,temp__5720__auto__,each_fixture_fn,G__9951,G__9951__$1,env,once_fixtures,each_fixtures,vec__9948,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_9968)));
});})(seq__9952,chunk__9953,count__9954,i__9955,t_9968,temp__5720__auto___9967__$1,v,seq__9952__$1,temp__5720__auto__,each_fixture_fn,G__9951,G__9951__$1,env,once_fixtures,each_fixtures,vec__9948,ns,vars__$1))
);
} else {
}


var G__9969 = cljs.core.next.call(null,seq__9952__$1);
var G__9970 = null;
var G__9971 = (0);
var G__9972 = (0);
seq__9952 = G__9969;
...
});})(each_fixture_fn,G__9951,G__9951__$1,env,once_fixtures,each_fixtures,vec__9948,ns,vars__$1))
);
});})(each_fixture_fn,G__9951,G__9951__$1,env,once_fixtures,each_fixtures,vec__9948,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__9951__$1)].join('')));

}
})());
});
;})(vec__9948,ns,vars__$1))
